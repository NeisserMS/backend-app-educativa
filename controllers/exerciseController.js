...
const predefinedExercises = {
  ...
  3: [
    ...
    { title: "Ejercicio 7: Pruebas Unitarias", description: "Descripción: Crea pruebas unitarias para la clase Persona, especialmente para los métodos que calculan o validan datos (por ejemplo, si la edad es válida). Entrada: Métodos de la clase Persona para realizar pruebas. Salida: Resultados esperados en formato de prueba unitaria." },
